...
const DICT = {
  th: {
    ...
    'wallet.saveBalance': 'บันทึกยอด',
    'wallet.balanceSaved': 'บันทึกยอด {wallet} สำเร็จ',
    'transfer.button': 'โอนระหว่างบัญชี',
    'transfer.title': 'โอนระหว่างบัญชี',
    'transfer.from': 'จากบัญชี',
    'transfer.to': 'ไปบัญชี',
    'transfer.descPlaceholder': 'เช่น โอนเข้ากองทุน',
    'transfer.save': '+ บันทึกการโอน',
    'transfer.errSame': 'บัญชีต้นทางและปลายทางต้องต่างกัน',
    'transfer.errAmount': 'กรอกจำนวนเงินให้ถูกต้อง (มากกว่า 0)',
    'transfer.saved': 'โอน {from} → {to} สำเร็จ',
    'transfer.label': 'โอนเงิน',
    'ws.title': 'สรุปรายเดือนแต่ละบัญชี',
    'ws.start': 'ยอดต้นเดือน',
    'ws.in': 'เงินเข้า',
    'ws.out': 'เงินออก',
    'ws.ending': 'ยอดสิ้นเดือน',
    'ws.pctUsed': 'ใช้ไปแล้ว',
  ...
  en: {
    ...
    'wallet.saveBalance': 'Save balance',
    'wallet.balanceSaved': '{wallet} balance saved',
    'transfer.button': 'Transfer between wallets',
    'transfer.title': 'Transfer between wallets',
    'transfer.from': 'From wallet',
    'transfer.to': 'To wallet',
    'transfer.descPlaceholder': 'e.g. Move to fund',
    'transfer.save': '+ Save transfer',
    'transfer.errSame': 'Source and destination wallets must differ',
    'transfer.errAmount': 'Enter a valid amount (greater than 0)',
    'transfer.saved': 'Transferred {from} → {to}',
    'transfer.label': 'Transfer',
    'ws.title': 'Monthly summary by wallet',
    'ws.start': 'Start',
    'ws.in': 'Money in',
    'ws.out': 'Money out',
    'ws.ending': 'Ending',
  ...
  ja: {
    ...
    'wallet.saveBalance': '残高を保存',
    'wallet.balanceSaved': '{wallet} の残高を保存しました',
    'transfer.button': '口座間で振替',
    'transfer.title': '口座間で振替',
    'transfer.from': '振替元口座',
    'transfer.to': '振替先口座',
    'transfer.descPlaceholder': '例：ファンドへ移動',
    'transfer.save': '+ 振替を保存',
    'transfer.errSame': '振替元と振替先の口座は異なる必要があります',
    'transfer.errAmount': '正しい金額（0より大きい）を入力してください',
    'transfer.saved': '{from} → {to} に振替しました',
    'transfer.label': '振替',
    'ws.title': '口座別月次サマリー',
    'ws.start': '月初残高',
    'ws.in': '入金',
